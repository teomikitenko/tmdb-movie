...
export const ChangeRaitingSerialsPage = createAsyncThunk(
  "serials/changeTopRaitingSerials",
...
export const SortGenreTopRatedSerials = createAsyncThunk(
  "serials/sortTopRaitingSerials",
  async ({  genre, sort }) => {
    const options = {
      method: "GET",
      headers: {
